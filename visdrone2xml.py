...
def transfer_to_xml(pic, txt, file_name):
    xml_save_path = 'data/VisDrone2019-DET-test-dev/xml'  # 生成的xml文件存储的文件夹
...
if __name__ == '__main__':
    ...
    txt_folder = 'data/VisDrone2019-DET-test-dev/annotations'  # visdrone txt标签文件夹
    txt_file = os.listdir(txt_folder)
    img_folder = 'data/VisDrone2019-DET-test-dev/images'  # visdrone 照片所在文件夹
